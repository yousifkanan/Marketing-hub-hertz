  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (editingUser) {
      ...
      await fetch('/api/users', {
        ...
        body: JSON.stringify({ id: userId, ...formData, password: formData.password || editingUser.password })
      });
  ...
  return (
    <div className="max-w-4xl space-y-8">
      <div>
        ...
        <p className="text-slate-500">Manage your team members and account details.</p>
      </div>
            ...
            >
              <div className="flex items-center justify-between mb-8">
                <h3 className="text-xl font-black flex items-center gap-2">
                  ...
                  {editingUser ? "Update Member" : "New Member"}
                </h3>
